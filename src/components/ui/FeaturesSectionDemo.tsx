...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "High-Performance Cryptocurrency Trade Simulator",
      description:
        "Processes real-time L2 orderbook data to estimate transaction costs and market impact",
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
       <div className="absolute w-[100%] mt-[8.5%]">
