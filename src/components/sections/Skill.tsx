...
function Skill() {
  return (
    <div className="hidden sm:block lg:block min-h-screen bg-black relative overflow-hidden">
      ...
      <div
        className="absolute bottom-0 left-1/2 mb-2 bg-gradient-to-b from-zinc-900 to-black transform -translate-x-1/2 w-[90%] h-[40%] border-t border-zinc-400/30 rounded-t-full shadow-[0_0_20px_rgba(113,113,122,0.3)]
"
      ></div>
...
"
      ...
      <div
        className="absolute top-1/4 left-0 w-32 h-64 border-r border-zinc-500/30 rounded-r-full shadow-[0_0_20px_rgba(113,113,122,0.3)]
 "
      ></div>
      <div
        className="absolute top-1/3 right-0 w-24 h-48 border-l border-zinc-400/25 rounded-l-full shadow-[0_0_20px_rgba(113,113,122,0.3)]
"
      ></div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center px-8 py-20">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="text-center mb-16">
            <h2 className="text-blue-400 text-xl font-semibold tracking-wider uppercase mb-4 drop-shadow-[0_0_8px_rgba(96,165,250,0.5)]">
              SKILLS
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-12 mt-32">
            ...
            <div className="bg-black backdrop-blur-3xl border border-zinc-800  rounded-l-2xl p-8 hover:border-zinc-700 transition-all duration-300  group">
            ...
            <div className="bg-orange-800/10  to-blue-800/20 scale-110 backdrop-blur-3xl border-2 border-orange-400 rounded-2xl p-8  transition-all duration-300 hover:shadow-[0_0_20px_rgba(251,146,60,0.3)] group relative">
            ...
            {/* Tools & DevOps */}
            <div className="bg-black backdrop-blur-3xl border border-zinc-800 rounded-r-2xl p-8 hover:border-zinc-700 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] group">
              <div className="text-center mb-6">
