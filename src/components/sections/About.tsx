    ...
    <section id="about" className="py-20 px-4 md:px-10 bg-black font-dm">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1  ">
            <h3 className="text-2xl font-semibold mb-4">A passionate Web Developer based in New York</h3>
            <p className="text-gray-300 mb-6">
              With over 5 years of experience, I specialize in creating modern web applications using cutting-edge technologies. My journey in web development began with a passion for building intuitive interfaces and has evolved into crafting comprehensive full-stack solutions.
            </p>
