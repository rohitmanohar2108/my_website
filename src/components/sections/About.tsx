        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-6">
              With over 5 years of experience, I specialize in creating modern web applications
              using cutting-edge technologies. My journey in web development began with a passion
              for building intuitive interfaces and has evolved into crafting comprehensive full-stack solutions.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className="p-4 bg-pink-500/5 hover:bg-pink-500/20 rounded-lg flex items-start border border-zinc-700 hover:border-pink-500">
              ...
              <div className="p-4 bg-blue-500/5 hover:bg-blue-500/20 rounded-lg flex items-start border border-zinc-700 hover:border-blue-500">
                ...
                <div>
                  <h4 className="font-semibold text-white mb-1">Design</h4>
